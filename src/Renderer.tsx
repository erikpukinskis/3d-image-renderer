...
export const Renderer: React.FC = () => {
  const render = (canvas: HTMLCanvasElement) => {
    ...
    gl.enableVertexAttribArray(gl.getAttribLocation(shaderProgram, "vertexData"));
...
function createShaderProgram(gl: WebGLRenderingContext) {
  ...
  var vertexShader = createSimpleVertexShader(gl);
...
function createSimpleVertexShader(gl: WebGLRenderingContext) {
